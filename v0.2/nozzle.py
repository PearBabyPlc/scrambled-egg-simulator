...
def initNozzle():
    ...
    global supAR
    global supAreaRatio
    supM = list(np.round(np.arange(1.,10.,0.0001), 5))
...
def getChokedST(ST, M, gamma):
    ST_chokedST = (egg.rayleighFunc(M, gamma)) / (egg.rayleighFunc(1, gamma))
...
def runNozzleSolver(gamma, Rs, R, airM, expansionRatio, chamberM, chamberP, chamberT, chamberD, chamberA):
    ...
    #print(exitM) this was for debug
    #print()
    ...
    return (exitM, exitP, exitD, exitT, exitV, exitSP, exitST, exitSD)
